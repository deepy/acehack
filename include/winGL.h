...
#define SDLGL_PROGRAM  "AceHack SDL/GL"
#define SDLGL_ICON     "AceHack"
#define SDLGL_ENV_VAR  "ACEHACKGLOPTIONS"
...
E void NDECL(Sdlgl_game_mode_selection);
...
E void NDECL(Sdlgl_suppress_more);
...
E void FDECL(Sdlgl_putstr_colored, (winid, int, int, const char *));
...
E tilecol_t FDECL(sdlgl_attr_to_tilecol, (int, int));
...
E void FDECL(Sdlgl_add_menu_colored, (winid,int,const ANY_P *,
...
E void FDECL(sdlgl_insert_text_item, (struct TextWindow *,
    struct TextItem *, int, int, int, const char *));
