...
static struct Bool_Opt
{
	...
	{"autoquiver", &flags.autoquiver, TRUE, SET_IN_FILE},
...
# endif
	...
	{"rest_on_space", &flags.rest_on_space, FALSE, SET_IN_FILE},
        {"room_colors", &iflags.roomcolors, FALSE, SET_IN_GAME},
...
#ifdef SORTLOOT
	{ "sortloot", "sort object selection lists by description", 4, SET_IN_FILE },
#endif
#ifdef MSDOS
