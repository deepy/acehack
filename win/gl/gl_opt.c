...
{
  fprintf(stderr,
      "AceHack " VERSION_STRING " - SDL/GL window port\n"
      "\n"
      "Some standard AceHack options:\n"
      ...
      "    --tileheight 16 : select tile height (16, 32, or 64).\n"
...
{
  fprintf(stderr, "AceHack version " VERSION_STRING
          " (SDL/GL window port)\n");
